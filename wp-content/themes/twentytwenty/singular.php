            ...
            <div class="contact-form-details h-100" style="background-image: url(<?=$background_images['form-bg']['url'] ?>)">
              ...
              <div class="contact-form-item">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="50" height="50" viewBox="0 0 50 50">
                  <defs>
                    <clipPath id="clip-path">
                      <rect id="Rectangle_22" data-name="Rectangle 22" width="50" height="50" transform="translate(399)" fill="#00ff6f" stroke="#707070" stroke-width="1"/>
                    </clipPath>
                  </defs>
                  <g id="Mask_Group_13" data-name="Mask Group 13" transform="translate(-399)" clip-path="url(#clip-path)">
                    <g id="phone" transform="translate(399 0)">
