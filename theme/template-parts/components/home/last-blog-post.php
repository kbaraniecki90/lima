    ...
    <div class="row last-post">
        ...
        <div class="col-12 col-lg-6">
          <div class="ms-lg-5 last-post-content">
            ...
            <p class="last-post-date mb-2">Data publikacji: <?= get_the_date( 'd.m.y', $postId)?> r.</p>
            <p class="last-post-intro-text">
              <?= substr(strip_tags($lastAddedPost['post_content']), 0, $readmore_limit).(($readmore_limit_reached)?'...':''); ?>
            </p>
            <a href="<?= get_permalink($postId); ?>" class="d-block mt-2 text-end text-decoration-underline fw-bold text-primary">Dowiedz się więcej</a>
          </div>
        </div>
      </div>
    </div>
